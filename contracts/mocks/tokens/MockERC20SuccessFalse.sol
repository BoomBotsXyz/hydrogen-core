 ...
 *
 * This implementation should NOT be used in production (unguarded mint, success=false).
 */
contract MockERC20SuccessFalse is ERC20 {

    uint8 internal _decimals;

    /**
     * @notice Constructs the MockERC20SuccessFalse contract.
